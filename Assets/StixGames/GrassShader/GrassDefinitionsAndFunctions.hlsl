...
// ================================== VARIABLES ================================
sampler2D _ColorMap;
fixed _TargetDensity;
fixed _DensityFalloffStart;
fixed _DensityFalloffScale;
fixed _DensityFalloffPower;
